...
#   1. local/debian12_rocm7.2          (minimal ROCm base)
#   2. local/debian12_rocm7.2_vllm_base (PyTorch, Flash Attention, aiter, etc.)
#   3. local/debian12_rocm7.2_vllm     (vLLM wheel and install)
#
...
echo "========================================"
echo "Images:"
echo "  local/debian12_rocm7.2"
echo "  local/debian12_rocm7.2_vllm_base"
echo "  local/debian12_rocm7.2_vllm"
echo ""
docker images | grep -E "local/debian12_rocm7.2|local/debian12_rocm7.2" || true